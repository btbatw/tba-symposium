        ...
        schedules: [{
            ...
            },
            {
				...
				},
				{
                    name: 'Ya Luan Hsiao',
                    nameCh: '',
                    affiliations: ['Philanthropy Advisor, Milken Institute'],
                    imgFileName: 'ya_luan_hsiao.jpg',
                    links: ['https://www.linkedin.com/in/ya-luan-hsiao-23539576/'],
					description: 'Dr. Hsiao is trained and Board-certified in Family Medicine and has completed fellowships in both Palliative Care and Geriatrics. During her residency and fellowship years, she participated in clinical trials and worked closely with researchers on quality improvement projects, especially for the elderly in Taiwan. To continue her interest in quality improvement, she received an MPH from Johns Hopkins School of Public Health. Ya Luan most recently was a faculty research associate at Johns Hopkins University where she conducted research on several important public health issues—from tracking the effectiveness of vaccines in Bangladesh to understanding the impact of e-cigarettes on youth. Currently, she serves as a consultant where she uses her clinical training and expertise for advisory services in venture philanthropy. She is also a Director in a Japanese-based start-up on mobile apps. Dr. Hsiao received a M.D. degree from National Yang Ming University in Taipei, Taiwan, and an MPH from the Johns Hopkins University School of Public Health.',
					infoSession: '',
				}
			]
            },
            ...
            },
            {
                ...
                speakers: [{
                    name: 'Tai-Yen Chen',
                    nameCh: '',
                    affiliations: ['Assistant Professor, Department of Chemistry, University of Houston'],
