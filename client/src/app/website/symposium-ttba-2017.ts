    ...
    talk: {
        ...
        schedules: [{
            ...
            },
            {
				...
				topic: '',
				sessionDescription: 'Let\'s choose speakers you are interested in and have an in-depth discussion with them! In the info session, there will be five subgroups focusing on <strong>A</strong>cademia, <strong>B</strong>iotechnology, <strong>C</strong>ancer research, <strong>D</strong>evelopment, and <strong>E</strong>nactment. All attendees will be assigned to the groups you selected, which will allow you to build a deeper connection with speakers.',
                tags: [],
                rooms: [],
                speakers: [{
                    name: null,
